...
# These imports are assumed to be correct from your original file
    ...
    def _register_event_handlers(self):
        ...
        async def on_connect():
            ...
            if self.config_manager.is_configured():
                ...
                # A minor improvement: AWAITING_SETUP is more accurate than DISCONNECTED
...
async def main():
    ...
    try:
        # Replaced the infinite sleep with the proper run method
        await api.run()
